...
from utils import TextLoader, eprint
...
def main():
    ...
    parser.add_argument('--training_loss', type=str, default='original',
                       choices=['original', 'hinge', 'softx','sigmx', 'softxl','sigmxl', 'wxe'],
                       help="['original', 'hinge', 'softx','sigmx', 'softxl','sigmxl', 'wxe']")
            ...
            for e in range(*epoch_range):
                ...
                for b in range(*batch_range):
                    ...
                    print("{:,d} / {:,d} (epoch {:.3f} / {}), loss {:.3f} (avg {:.3f}), {:.3f}s" \
                        .format(b, data_loader.total_batch_count, e + b / batch_range[1], epoch_range[1],
